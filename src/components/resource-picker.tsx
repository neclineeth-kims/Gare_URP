  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <DialogTitle>Add Sub-Resource</DialogTitle>
          <DialogDescription>
            Operator labor and fuel/materials consumed per equipment unit. EDC = sum of these costs.
          </DialogDescription>
        </DialogHeader>
        <Tabs defaultValue="labor">
          ...
          <TabsContent value="labor">
            <div className="space-y-4 pt-4">
                  ...
                  <div className="divide-y">
                    {filteredLabor.map((l) => (
                      ...
                      >
                        ...
                        <span className="text-muted-foreground">{l.rate}/{l.unit}</span>
                      </button>
                    ))}
                  </div>
                )}
              ...
              <div className="flex items-center gap-4">
                <div>
                  <label className="text-sm font-medium">Qty per equipment unit</label>
                  <Input
                    type="number"
                    step="0.01"
                    min="0.001"
          ...
          <TabsContent value="material">
            <div className="space-y-4 pt-4">
                  ...
                  <div className="divide-y">
                    {filteredMaterials.map((m) => (
                      ...
                      >
                        ...
                        <span className="text-muted-foreground">{m.rate}/{m.unit}</span>
                      </button>
                    ))}
                  </div>
                )}
              ...
              <div className="flex items-center gap-4">
                <div>
                  <label className="text-sm font-medium">Quantity per equipment unit</label>
                  <Input
                    type="number"
                    step="0.01"
                    min="0.001"
